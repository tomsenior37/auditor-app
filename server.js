...
app.get('/api/report/:id', async (req, res) => {
  ...
  try {
    ...
    const safeName = (namingPattern
      .replace('{templateName}', rec.templateName || 'inspection')
      .replace('{location}', rec.location || '')
      .replace('{equipment}', rec.machine || '')
      .replace('{component}', rec.guardId || rec.componentId || '')
      .replace('{inspector}', rec.inspector || '')
      .replace('{date}', dateStr)
      .replace('{result}', rec.result || 'PENDING')
